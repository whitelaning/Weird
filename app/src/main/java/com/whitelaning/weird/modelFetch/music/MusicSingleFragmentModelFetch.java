 ...
 */
public class MusicSingleFragmentModelFetch extends BaseModelFetch {
    public List<ModelMusicInfo> list = new ArrayList<>();

    public MusicSingleFragmentModelFetch(Context mContext, Handler mHandler) {
