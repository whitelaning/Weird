...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "7zhou";
    ...
    public static String getString(String key) {
        return getString(FrameworkApplication.getContext(), key, null);
    }

    public static String getString(String key,String defaultString) {
        return getString(FrameworkApplication.getContext(), key, defaultString);
    }
    ...
    public static long getLong(String key) {
        return getLong(FrameworkApplication.getContext(), key, -1);
    }
    ...
    public static boolean putBoolean(String key, boolean value) {
        return putBoolean(FrameworkApplication.getContext(), key, value);
    }
    ...
    public static boolean getBoolean(String key) {
        return getBoolean(FrameworkApplication.getContext(), key, false);
    }
